...
function PageUrlValidation(url)
{
	...
	{
		var L_InvalidPageUrl_Text="無効なページの URL: ";
...
{
	var L_NoWSSClient_Text="リストをエクスポートするには、Windows SharePoint Services 互換のアプリケーションおよび Microsoft Internet Explorer 6.0 以降が必要です。";
	var L_ExportDBFail_Text="データペースにエクスポートできませんでした。リストをエクスポートするには、Windows SharePoint Services 互換のアプリケーションが必要です。";
...
{
	var L_ExportListSpreadsheet_Text="リストをエクスポートするには、Windows SharePoint Services 互換のアプリケーションが必要です。";
...
function ExportDiagram(weburl,listguid, listid, listname, viewname, viewguid)
{
	...
	{
		var L_DiagramLaunchFail_Text="図表を作成できません。";
...
var L_NoQuestion_Text="アンケートに質問がありません。";
var L_NoVoteAllowed_Text="このアンケートに再度回答することはできません。";
...
function SubmitSearchForView(ViewGuid)
{
	...
	if (""==searchText)
	{
		var L_Enter_Text="検索する単語を 1 つ以上入力してください。";
		alert(L_Enter_Text);
...
var fNewDoc2=false;
var fNewDoc3=false;
var L_EditDocumentProgIDError_Text="'ドキュメントの編集' を利用するには、Windows SharePoint Services 互換のアプリケーションおよび Microsoft Internet Explorer 6.0 以降が必要です。";
var L_EditDocumentRuntimeError_Text="ドキュメントを編集用に開くことができませんでした。ドキュメントの編集に使用する Windows SharePoint Services 互換のアプリケーションが見つかりませんでした。";
...
var L_OpenDocumentLocalError_Text="このドキュメントはオフラインで編集されましたが、SharePoint からドキュメントを開くために構成されたアプリケーションがありません。ドキュメントは読み取り専用でのみ開くことができます。";
...
var L_RelativeUrlError_Text="現在のページで始まるアドレスは正しく表示されない可能性があります。完全な URL か、現在のサーバーで始まるアドレスを入力してください。";
var L_UnknownProtocolUrlError_Text="ハイパーリンクは、http://、https://、mailto:、news:、ftp://、file://、または \\\\ で開始します。アドレスを確認して、もう一度試してください。";
var L_UrlTooLongError_Text="場所の URL は、クエリ パラメータを除外して 256 文字以内にしてください。クエリ パラメータは疑問符 (?) で始まります。"
...
{
	var L_DeletePartialResponse1_text="アンケートの一部に対する回答が保存されました。この回答を削除するには、[OK] をクリックしてください。このアンケートに対する回答を後で続行するには、[キャンセル] をクリックします。アンケートの一部に対して記入した回答は [すべての回答] アンケート ビューで参照できます。\n\nこの回答をサイトのごみ箱に移動してもよろしいですか?";
	var L_DeletePartialResponse2_text="アンケートの一部に対する回答が保存されました。この回答を削除するには、[OK] をクリックしてください。このアンケートに対する回答を後で続行するには、[キャンセル] をクリックします。アンケートの一部に対して記入した回答は [すべての回答] アンケート ビューで参照できます。\n\nこの回答を削除してもよろしいですか?";
	var message="";
	if (recycleBinEnabled==1)
...
{
	var L_Version_Restore_Confirm_Text="現在のバージョンを選択したバージョンで置き換えようとしています。";
	var message=L_Version_Restore_Confirm_Text;
	return confirm(message);
}
function DeleteItemVersionConfirmation(bRecycleBinEnabled)
{
	var L_Version_Delete_Confirm_Text="このバージョンを削除してもよろしいですか?";
	var L_Version_Recycle_Confirm_Text="このバージョンをサイトのごみ箱に移動してもよろしいですか?";
...
{
	var L_User_Delete_Confirm_Text="このユーザーを削除しようとしています。";
...
{
	var L_IE5upRequired_Text="'ディスカッション' を利用するには、Windows SharePoint Services 互換のアプリケーションおよび Microsoft Internet Explorer 6.0 以降が必要です。";
	if (browseris.ie5up && browseris.win32)
...
var L_Edit_Text="編集";
var L_ViewItem_Text="アイテムの表示";
var L_EditItem_Text="アイテムの編集";
var L_EditSeriesItem_Text="定期的なアイテムの編集";
var L_DeleteItem_Text="アイテムの削除";
var L_DeleteDocItem_Text="削除";
var L_ViewProperties_Text="プロパティの表示";
var L_EditProperties_Text="プロパティの編集";
var L_ViewResponse_Text="回答の表示";
var L_EditResponse_Text="回答の編集";
var L_DeleteResponse_Text="回答の削除";
var L_Subscribe_Text="通知";
var L_CustomizeNewButton_Text="新規ボタンの順序の変更";
var L_Review_Text="校閲者へ送信";
var L_EditIn_Text="^1 で編集";
var L_EditInApplication_Text="ドキュメントの編集"
var L_Checkin_Text="チェックイン";
var L_Checkout_Text="チェックアウト";
var L_DiscardCheckou_Text="チェックアウトの破棄";
var L_CreateDWS_Text="ドキュメント ワークスペースの作成";
var L_PublishBack_Text="元の場所へ発行";
var L_Versions_Text="バージョン履歴";
var L_WorkOffline_Text="クライアントに接続";
var L_Reply_Text="返信";
var L_ExportContact_Text="連絡先のエクスポート";
var L_ExportEvent_Text="イベントのエクスポート";
var L_Reschedule_Text="再スケジュールのオプション";
var L_Move_Text="移動";
var L_Keep_Text="保持";
var L_Delete_Text="削除";
var L_Open_Text="開く";
var L_SiteSettings_Text="サイト設定の変更";
var L_ManageUsers_Text="ユーザーの管理";
var L_DeleteSite_Text="サイトの削除";
var L_SiteStorage_Text="サイトの記憶域の管理";
var L_MngPerms_Text="権限の管理";
var L_Settings_Text="設定";
var L_Remove_Text="このリストから削除";
var L_ModerateItem_Text="承認/却下";
var L_PublishItem_Text="メジャー バージョンの発行";
var L_CancelPublish_Text="承認の取り消し";
var L_UnPublishItem_Text="このバージョンの発行を停止";
var L_DownloadOriginal_Text="画像のダウンロード";
var L_EditVersion_Text="編集";
var L_EditInOIS_Text="画像の編集";
var L_Workflows_Text="ワークフロー";
var L_Send_Text="送信";
var L_ExistingCopies_Text="既存のコピー";
var L_OtherLocation_Text="その他の場所";
var L_GoToSourceItem_Text="ソース アイテムに移動";
var L_NotifyThisIsCopy_Text="このアイテムは他の場所からコピーされたため、その場所から更新が送信されてくる可能性があります。コピー元で更新の送信が停止していることを確認してください。停止していないと、このアイテムが再作成されます。\n\n";
var L_SendToEmail_Text="リンクを電子メールで送信";
var L_DownloadACopy_Text="コピーのダウンロード";
var L_DocTran_Text="ドキュメントの変換";
var L_AddToMyLinks_Text="個人用リンクに追加";
var L_AddToCategory_Text="ポータル エリアに送信";
var L_VS_DownArrow_Text="ビューの選択";
var L_ModifyView="このビューの変更";
var L_CreateView="新しいビューの作成";
...
var L_UndoCheckoutWarning_Text="チェックアウト バージョンを破棄すると、ドキュメントに対するすべての変更内容が失われます。チェックアウト バージョンを破棄してもよろしいですか?";
var L_UnPublishWarning_Text=" このバージョンのドキュメントの発行を停止してもよろしいですか?";
var L_CancleApproval_TEXT=" このドキュメントの承認を取り消してもよろしいですか?";
...
var L_EmptySlideShow_Text="ライブラリに画像がありません。画像を追加し、もう一度試してください。";
var L_NotOurView_Text="この操作は現在のビューでは完了できません。他のビューを選択して、もう一度試してください。";
...
function MtgToggleTimeZone()
{
	...
	var L_ShowTZ_Text="タイム ゾーンを表示する";
	var L_HideTZ_Text="タイム ゾーンを表示しない";
...
{
	var L_MtgKeepConfirm_Text="この会議の日付の情報は、予定表のプログラムにある情報と一致しません。この会議の日付を保持する場合、ワークスペースにある関連する会議のリストに表示されます。";
...
{
	var L_MtgDeleteConfirm_Text="この会議の日付およびそれに関連付けられているコンテンツは、ワークスペースから削除されます。";
...
{
	var L_DeleteGlobalConfirm_Text="このページは、このワークスペースに関連付けられたすべての会議から削除されます。";
	var L_DeleteConfirm_Text="このページを削除してもよろしいですか?";
	var text;
...
var L_NotSortable_Text="この列は並べ替えられません";
var L_NotFilterable_Text="この列はフィルタできません";
var L_AOnTop_Text="昇順";
var L_ZOnTop_Text="降順";
var L_SmallestOnTop_Text="昇順";
var L_LargestOnTop_Text="降順";
var L_OldestOnTop_Text="日付の古いアイテム";
var L_NewestOnTop_Text="日付の新しいアイテム";
var L_AttachmentsOnTop_Text="添付ファイルのあるアイテム";
var L_BlanksOnTop_Text="空のアイテム";
var L_Ascending_Text="昇順";
var L_Descending_Text="降順";
var L_DontFilterBy_Text="^1 のフィルタをクリア";
var L_Loading_Text="読み込み中....";
var L_FilterMode_Text="フィルタの選択肢を表示する";
var L_OpenMenu_Text="メニューを開く";
...
function PickerDialogShowWait(ctx)
{
	...
	if (resultControl !=null)
	{
		...
		if(nav4)
			...
			parent=resultControl.parentElement;
		var L_GearToolTip_TEXT="クエリを実行中です。しばらくお待ちください...";
		var L_PleaseWait_TEXT="クエリが処理されるまで、しばらくお待ちください。";
...
{
	var L_ResetPagePersonalizationDialog_TXT="Web パーツのすべての個人用設定を共有値にリセットし、個人用の Web パーツを削除しようとしています。この操作を完了する場合は、[OK] をクリックしてください。個人用の Web パーツおよびその設定を保存する場合は、[キャンセル] をクリックしてください。";
	var L_ResetPartPersonalizationDialog_TXT="この Web パーツをリセットすると、これまでの変更が失われます。この操作を続行してもよろしいですか? この Web パーツをリセットする場合は [OK] を、変更を保持する場合は [キャンセル] をクリックしてください。";
	var L_RemoveConnection_TXT="%0 Web パーツと %1 Web パーツ間の接続を削除してもよろしいですか? 接続を削除するには、[OK] をクリックします。接続を維持する場合は、[キャンセル] をクリックします。";
	var L_ExportPersonalization_TXT="この Web パーツ ページは個人用に設定されています。その結果、1 つまたは複数の Web パーツのプロパティには、機密情報が含まれている可能性があります。プロパティに含まれる情報が第三者に見られても安全であることを確認してください。この Web パーツをエクスポートした後、メモ帳などのテキスト エディタを使って、Web パーツの説明ファイル (.webpart または .dwp) のプロパティを確認してください。";
	var L_GetPropertiesFailure_ERR="現在、プロパティを取得できません。";
	var L_SaveDirtyParts_TXT="このページの 1 つまたは複数の Web パーツのコンテンツに変更が加えられました。変更を保存する場合は [OK] を、変更を破棄する場合は [キャンセル] をクリックしてください。";
	var L_ToolPaneWidenToolTip_TXT="幅を広げる";
	var L_ToolPaneShrinkToolTip_TXT="幅を狭める";
	var L_ToolPartExpandToolTip_TXT="ツール パーツの展開: %0";
	var L_ToolPartCollapseToolTip_TXT="ツール パーツの折りたたみ: %0";
	var L_WebPartBackgroundColor_TXT="Web パーツの背景色";
	var L_TransparentTooltip_TXT="Web パーツの背景色の透明化";
	var L_InvalidURLPath_ERR="URL は、%0 プロパティに対して正しくありません。URL およびパスを確認して、もう一度試してください。";
	var L_InvalidFolderPath_ERR="フォルダへのパスは、%0 プロパティに対して正しくありません。パス名を確認して、もう一度試してください。";
	var L_InvalidFilePath_ERR="ファイルまたはフォルダへのパスが正しくありません。パスを確認して、もう一度試してください。";
	var L_FileOrFolderUnsupported_ERR="現在お使いのブラウザは、ファイルまたはフォルダへのリンクをサポートしていません。ファイルまたはフォルダへのリンクを指定するには、Microsoft Internet Explorer 5.0 以降を使用してください。";
	var L_Link_TXT="リンク";
	var L_TransparentLiteral_TXT="透明";
	var L_ContentEditorSaveFailed_ERR="変更を保存できません。";
	var L_AccessDenied_ERR="Web パーツのプロパティを保存できません: Web パーツがページに直接埋め込まれているか、またはプロパティを保存するための権限がありません。";
	var L_NoInitArgs_ERR="接続を作成または変更できません。いずれかの Web パーツに、データ フィールドがありません。";
	var s=new Object();
...
var L_AccessibleMenu_Text="メニュー";
function FNEmpWz(wz)
{
	return (wz&&wz!="");
}
...
var L_NewFormLibTb3_Text="ドキュメントを結合できませんでした。\n必要なアプリケーションが正しくインストールされていないか、このドキュメント ライブラリのテンプレートを開くことができない可能性があります。\n\n次の操作を行ってください:\n1. このドキュメント ライブラリの [全般設定] でテンプレートの名前を調べ、テンプレートを開くために必要なアプリケーションをインストールします。アプリケーションが初回実行時にインストールされるように設定されている場合は、アプリケーションを実行し、新しいドキュメントをもう一度作成してください。\n\n2. このドキュメント ライブラリを変更する権限を持っている場合は、ライブラリの [全般設定] に移動し、新しいテンプレートを構成してください。";
var L_NewFormLibTb4_Text="結合するドキュメントを選択し、ツール バーの [選択したドキュメントを結合] をクリックしてください。";
...
var L_NewFormLibTb5_Text="再リンクするドキュメントを選択し、ツール バーの [選択したドキュメントを再リンク] をクリックしてください。";
var L_NewFormLibTb6_Text="一度に再リンクできるドキュメント数は 500 個までです。ドキュメントの選択を変更し、再度実行してください。";
...
var L_ViewVersion_Text="表示";
var L_RestoreVersion_Text="復元";
var L_DeleteVersion_Text="削除";
var L_DenyVersion_Text="このバージョンを却下";
var L_UnPublishVersion_Text="このバージョンの発行を停止";
...
var L_Version_Restore_Confirm_Text="現在のバージョンを選択したバージョンで置き換えようとしています。";
var L_Version_RestoreVersioningOff_Confirm_Text="バージョン機能は現在無効に設定されています。その結果、現在のバージョンは上書きされ、このバージョンへのすべての変更は失われます。";
var L_Version_NoRestore_Current_ERR="現在のバージョンを復元できません。";
...
var L_Version_NoOffline_NonCurrent_ERR="オフラインにできるのは、現在発行されているか承認されているバージョンのみです。";
var L_Version_unpublish_Confirm_Text="このバージョンのドキュメントの発行を停止してもよろしいですか?";
var L_Version_deny_Confirm_Text="このバージョンのドキュメントを拒否してもよろしいですか?";
...
var L_Version_Delete_Confirm_Text="このバージョンを削除してもよろしいですか?";
var L_Version_Recycle_Confirm_Text="このバージョンをサイトのごみ箱に移動してもよろしいですか?";
var L_Version_NoDelete_Current_ERR="現在のチェックイン バージョン、メジャー バージョン、または承認済みバージョンは削除できません。";
...
var L_Version_DeleteAll_Confirm_Text="このファイルに関連付けられた以前のすべてのバージョンを削除してもよろしいですか?";
var L_Version_RecycleAll_Confirm_Text="このファイルに関連付けられた以前のすべてのバージョンをごみ箱に移動してもよろしいですか?";
var L_Version_DeleteAllMinor_Confirm_Text="このファイルの以前の下書きバージョンをすべて削除してもよろしいですか?";
var L_Version_RecycleAllMinor_Confirm_Text="このファイルの以前の下書きバージョンをすべてサイトのごみ箱に移動してもよろしいですか?";
var L_Version_NoDeleteAll_None_ERR="削除する以前のバージョンはありません。";
